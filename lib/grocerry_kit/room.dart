...
//         'SELECT title, count FROM rooms, room_people WHERE room_people.room_id = rooms.room_id AND room_people.ID = 9'
//     );
//
...
//                         Navigator.push(
//                             context,
//                             MaterialPageRoute(builder: (context) => BoardPage(room_id: widget))
//                         );
//                       }
//                   ),
//                 ],
